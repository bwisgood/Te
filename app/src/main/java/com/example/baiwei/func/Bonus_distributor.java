...
import com.example.baiwei.thread.Bonus_thread_distributor;
...
public class Bonus_distributor extends Activity{
 ...
 private String user_id;
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    //showToast("123");
                    Bonus_adapter list_item=new Bonus_adapter(Bonus_distributor.this,list);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bonus_distributor);
        Intent intent = getIntent();
        Bundle bundle = intent.getExtras();
        user_id = bundle.getString("user_id");
        lv = (ListView) findViewById(R.id.lv3);
        new Bonus_thread_distributor("http://www.scolgo.cn/index.php/home/index/bonus",user_id,handler,list,Bonus_distributor.this).start();


        CustomTitleBar customTitleBar = (CustomTitleBar) findViewById(R.id.ct_bonus_distributor);
