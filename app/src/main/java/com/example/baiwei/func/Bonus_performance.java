...
public class Bonus_performance extends Activity {
    ...
    private Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    //showToast("123");
                    Bonus_adapter list_item=new Bonus_adapter(Bonus_performance.this,list);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bonus_performance);
        Intent intent = getIntent();
        Bundle bundle = intent.getExtras();
        user_id = bundle.getString("user_id");
        lv = (ListView) findViewById(R.id.lv4);

        new Bonus_thread_perfomance("http://www.scolgo.cn/index.php/home/index/bonus",user_id,handler,list,Bonus_performance.this).start();


        CustomTitleBar customTitleBar = (CustomTitleBar) findViewById(R.id.ct_bonus_performance);
