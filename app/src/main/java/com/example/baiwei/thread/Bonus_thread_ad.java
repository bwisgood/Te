...
public class Bonus_thread_ad extends Thread {
    ...
    public Bonus_thread_ad(String url, String user_id, Handler handler, ArrayList<Map<String, Object>> list, Context context) {
        this.url = url;
        ...
        try {
            ...
            for (int i = 0; i < resultArray.length(); i++) {
                ...
                try {
                    ...
                    String title = object.getString("ad");
