...
/**
 * Created by baiwei on 2017/7/15.
 */

public class Transcation_thread extends Thread {
    ...
    public Transcation_thread(String url, String user_id, Handler handler, ArrayList<Map<String, Object>> list, Context context) {
        this.url = url;
        ...
        try {
            ...
            for (int i = 0; i < resultArray.length(); i++) {
                ...
                try {
                    ...
                    String title = object.getString("actual");
