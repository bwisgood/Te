...
public class Withdraw_thread extends Thread {
    ...
    public Withdraw_thread(String url, String user_id, Handler handler, ArrayList<Map<String, Object>> list, Context context) {
        this.url = url;
    ...
    public void doGet() {
        ...
        try {
            ...
            if (connection.getResponseCode() == 200) {
                ...
                System.out.println("wirhdraw_re:"+stringBuffer.toString());
            }
        ...
        try {
            ...
            for (int i = 0; i < resultArray.length(); i++) {
                ...
                try {
                    ...
                    String title = object.getString("amount");
